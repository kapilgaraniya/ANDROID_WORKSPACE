...
class BookAppointmentActivity : AppCompatActivity() {
    ...
    private fun bookAppointment(patient: Patient, doctorId: String, doctorName: String, date: String, timeSlot: String) {
        ...
        databaseReference.child(appointmentId).setValue(appointment)
            .addOnSuccessListener {
                Toast.makeText(applicationContext, "Appointment booked successfully!", Toast.LENGTH_SHORT).show()
                showSuccessDialog()
            }
            .addOnFailureListener { error ->
                Toast.makeText(applicationContext, "Failed to book appointment: ${error.message}", Toast.LENGTH_SHORT).show()
            }
    }
    ...
    private fun showSuccessDialog() {
        ...
        dialogView.findViewById<Button>(R.id.btn_ok).setOnClickListener {
            ...
            startActivity(Intent(applicationContext, PatientDashboardActivity::class.java))
        }
    }
